                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="search_box pull-right">
                            <input type="text" name="keywords_submit" placeholder="Tìm kiếm sản phẩm" style="width: 450px;"/>
                            <input type="submit" style="margin-top:0;color:white;width: 80px;" name="search_items" class="btn btn-primary btn-sm" value="Tìm kiếm">
                        </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="brands_products"><!--brands_products-->
                            <h2 style="color:blue">Thương hiệu sản phẩm</h2>
