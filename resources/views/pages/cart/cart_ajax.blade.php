				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_price">
								<p style="margin-top: 10px; color:orange">{{number_format($cart['product_price'],0,',','.')}} VNĐ</p>
							</td>
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<input style="width: 100px;" class="cart_quantity" type="number" min="1" name="cart_qty[{{$cart['session_id']}}]" value="{{$cart['product_qty']}}"  >
								</div>
							</td>
							<td class="cart_total">
								<p style="margin-top: 10px; color: red;" class="cart_total_price">
